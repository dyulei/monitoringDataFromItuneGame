...
def saveDataBase(appType, appTypeNum):
	for i in range(1, 201):
		html = open('/Users/Levi/github/monitoringDataFromItuneGame/2014-08-19%s/%d.html' % (appType, i) , 'r')
		...
		tb_rank = ("insert into tb_rank (app_id, rank_type, rank, created_at, updated_at) values ('%d', '%d', '%d','%s', '%s')" % (hjson['results'][0]['trackId'], appTypeNum,i,str_time, str_time))
